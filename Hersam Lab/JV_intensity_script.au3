...
For $i = 0 To UBound($filter_positions)-1
   ...
   Local $partial_path = "C:\Users\Impedance Users\Desktop\IPDA Measurements\Data\"&$device_name&" JV Data\"&$device_name&"_JV_"&$filters[$filter_positions[$i]-1]&"OD"
   If $filter_positions[$i] = 1 Then
	  $partial_path = "C:\Users\Impedance Users\Desktop\IPDA Measurements\Data\"&$device_name&" JV Data\"&$device_name&"_JV_1sun"
   EndIf
   If $filter_positions[$i] = 12 Then
	  $partial_path = "C:\Users\Impedance Users\Desktop\IPDA Measurements\Data\"&$device_name&" JV Data\"&$device_name&"_JV_dark"
   EndIf
